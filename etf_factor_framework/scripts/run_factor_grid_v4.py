"""
run_factor_grid_v4.py
---------------------
Same as run_factor_grid_v3.py, with an additional --data-dir argument to
specify the china_stock_data directory (containing tushare.db and lixinger.db).

Usage (run from etf_factor_framework directory):
    python scripts/run_factor_grid_v4.py --config config/factors/pb_grid.yaml
    python scripts/run_factor_grid_v4.py --config config/factors/pb_grid.yaml --workers 4
    python scripts/run_factor_grid_v4.py --config config/factors/pb_grid.yaml --data-dir /path/to/china_stock_data

Config keys: same as run_factor_grid_v3.py, plus optional:
...
def main():
    ...
    lixinger_db = os.path.join(data_dir, 'lixinger.db')
    ...
    fd            = FundamentalData(start_date=start_date, end_date=end_date,
                                    tushare_db=tushare_db, lixinger_db=lixinger_db)
