...
# Script lives in etf_factor_framework/scripts/, so parent.parent = etf_factor_framework
SCRIPT_DIR = Path(__file__).resolve().parent
SRC = SCRIPT_DIR.parent                          # etf_factor_framework
PROJECT_ROOT = SRC.parent.parent                  # code_project_v2
DST = PROJECT_ROOT / "factor_framework" / "etf_factor_framework"
