...
def test_factor_basic():
    ...
    # 检查输出格式
    assert factor_data.values.shape == (ohlcv.n_assets, ohlcv.n_periods), f"因子形状不匹配: {factor_data.values.shape} vs ({ohlcv.n_assets}, {ohlcv.n_periods})"
