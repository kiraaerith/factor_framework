...
from factors.ctc.volume_price_split import LowVolReturnStd
...
def main():
    ...
    # 方法1: 使用便捷函数检测
    print("\n" + "="*60)
    print("Data Leakage Detection (using convenient function)")
    print("="*60)
    ...
    if report.has_leakage:
        ...
        print(f"OK: {factor.name} has no data leakage, can proceed with evaluation")
        return True
