...
from factors.ctc.price_volume_split import LowPriceVolumeChange
...
def test_factor_basic():
    """测试因子基础功能"""
    print("="*60)
    print("测试1: LowPriceVolumeChange 因子基础功能")
    print("="*60)
    ...
    # 检查输出格式
    assert factor_data.shape == (ohlcv.n_assets, ohlcv.n_periods), f"因子形状{factor_data.shape}与数据不匹配"
